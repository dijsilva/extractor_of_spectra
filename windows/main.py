...
def openDialogSave():
    directorySave = filedialog.asksaveasfilename(initialdir =  "/home", title = "Select A File", filetypes=([('Excel Files', '*.xlsx'), ('Comma-separated values', '*.csv')]), defaultextension='.xlsx')
    if directorySave:
...
def handleSubmmit():
    ...
    progress['value'] = 75
    loadingStatus.set('Extracting spectra ')
    app.update_idletasks()
...
labelOfSpectrometer.place(width=155, relheight=0.15, rely=0.85, relx=0)
...
labelOfSaveFile.place(width=222, relheight=0.15, rely=0.35, relx=0)
...
commaSepVarButton.place(width=222.5, relheight=0.2, rely=0.45, relx=0)
...
labelOfLoadingStatus.place(relheight=0.031, rely=0.835, relx=0.4)



labelOfLoadingStatus = tk.Label(app, text='Developed by Diego Silva', anchor='center', bg='#d4d4d4', font='TkDefaultFont 7 bold')
labelOfLoadingStatus.place(relheight=0.028, rely=0.95, relx=0.0)
labelOfLoadingStatus = tk.Label(app, text='www.github.com/dijsilva', anchor='center', bg='#d4d4d4', font='TkDefaultFont 7 bold')
